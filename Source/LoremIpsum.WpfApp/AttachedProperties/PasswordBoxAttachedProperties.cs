...
namespace LoremIpsum.WpfApp
{
    ...
    /// <summary>
    /// The label text attached property for a <see cref="TextBox"/> and <see cref="PasswordBox"/>/>
    /// </summary>
    public class LabelTextProperty : BaseAttachedProperty<LabelTextProperty, string>
    {

    }

    /// <summary>
    /// The foreground of the label text attached property for a <see cref="TextBox"/> and <see cref="PasswordBox"/>/>
    /// </summary>
    public class LabelTextForegroundProperty : BaseAttachedProperty<LabelTextForegroundProperty, Brush>
    {
