    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(maxLength: 36, nullable: false),
                    DateCreated = table.Column<DateTimeOffset>(nullable: false, defaultValue: new DateTimeOffset(new DateTime(2020, 2, 15, 4, 29, 13, 740, DateTimeKind.Unspecified).AddTicks(1937), new TimeSpan(0, 0, 0, 0, 0))),
                    DateModified = table.Column<DateTimeOffset>(nullable: false, defaultValue: new DateTimeOffset(new DateTime(2020, 2, 15, 4, 29, 13, 746, DateTimeKind.Unspecified).AddTicks(4681), new TimeSpan(0, 0, 0, 0, 0))),
                    CreatedBy = table.Column<string>(maxLength: 36, nullable: false),
                    ModifiedBy = table.Column<string>(maxLength: 36, nullable: false),
                    ...
                    SSSNnumber = table.Column<string>(nullable: true),
                    TINNumber = table.Column<string>(nullable: true),
                    PHICNumber = table.Column<string>(nullable: true),
                    HDMFNumber = table.Column<string>(nullable: true),
                    HireDate = table.Column<DateTimeOffset>(nullable: false),
                    ResignedDate = table.Column<DateTimeOffset>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffectivityDate = table.Column<DateTimeOffset>(nullable: false)
                },
                constraints: table =>
                {
